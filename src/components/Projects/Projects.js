...
// import lb from "../../Assets/loadbalancer.png";
...
//                 description={
//                   <>
//                     ⚖️ Built a custom HTTP load balancer in Python using sockets and multithreading to distribute traffic across multiple 
//                     backend servers with round-robin scheduling and real-time health checks for high availability and fault tolerance.
//                     <br /> <br />
//                     ⚙️ Tools & Technologies: Python, Flask, Multithreading, Multiprocessing, HTTP (requests), cURL
//                     <br /> <br />
//                     🎯 Skills: Load Balancing, Fault Tolerance, Socket Programming, Multithreading, Multiprocessing, HTTP Protocol, Concurrent Programming
//                   </>
//                 }
//                 ghLink="https://github.com/SachinBhardwaj1/CC_Build-You-Own-Load-Balancer"
//                 demoLink=""
//               />
//             </Col>
...
function Projects() {
  ...
  const allProjects = [
    <Col md={4} className="project-card">
      <ProjectCard
        imgPath={lb}
        title={<span className="glowing-title">SmartLB</span>}
        description={
          <>
            ⚖️ Built a custom HTTP load balancer in Python using sockets and multithreading to distribute traffic across multiple 
            backend servers with round-robin scheduling and real-time health checks for high availability and fault tolerance.
    ...
    <Col md={4} className="project-card">
      <ProjectCard
        imgPath={db}
        title={<span className="glowing-title">TrackNScaleDB</span>}
        description={
          <>
            🛢️ Developed a robust SQL-based database system with 50,000+ records, enabling efficient tracking of job applications, interviews, and offers for employees and employers at scale.
            <br /> <br />
    ...
    <Col md={4} className="project-card">
      <ProjectCard
        imgPath={aws}
        title={<span className="glowing-title">Secured AWS Cloud Architecture Solution</span>}
        description={
          <>
            ☁️ Built a scalable AWS infrastructure for applications using Aurora serverless and auto-scaling with load balancing, resulting in 99.9% uptime and a 40% boost in response time.
            <br /> <br />
    ...
    <Col md={4} className="project-card">
      <ProjectCard
        imgPath={cultural}
        title={<span className="glowing-title">Research Paper - Cultural Differences in Data Privacy: Understanding Global Perspectives</span>}
        description={
          <>
            📑 Analyzed privacy regulations in 8 countries and surveyed over 1,000+ participants to summarize cultural impacts on data privacy attitudes and behaviors.
            <br /> <br />
    ...
    <Col md={4} className="project-card">
      <ProjectCard
        imgPath={mongo}
        title={<span className="glowing-title">TurboMongo</span>}
        description={
          <>
            🍃 Architected an application for efficient data migration to MongoDB, achieved a 15% improvement in data insertion speed for large datasets, reduced downtime, and enhanced overall data accessibility.
            <br /> <br />
    ...
    <Col md={4} className="project-card">
      <ProjectCard
        imgPath={dv}
        title={<span className="glowing-title">Mental Health & Stress Level Insights Across Industries</span>}
        description={
          <>
            📡 Optimized the dataset with 10,000+ records to analyze remote work impact on stress, job satisfaction, work-life balance, and mental health, driving insights for HR teams and researchers.
            <br /> <br />
    ...
    <Col md={4} className="project-card">
      <ProjectCard
        imgPath={toppinghub}
        title={<span className="glowing-title">Topping Hub</span>}
        description={
          <>
            ⚛️ Developed server-side applications with Node JS and MongoDB, ensuring efficient data handling and achieving a 30% increase in system performance and reliability. 
            <br /> <br />
    ...
    <Col md={4} className="project-card">
      <ProjectCard
        imgPath={skytrack}
        title={<span className="glowing-title">SkyTrack Vision</span>}
        description={
          <>
            ✈️ Managed and optimized 1TB+ of data using Hadoop's HDFS and Hive, reducing data processing time by 20% and enabling real-time analysis of huge datasets. 
            <br /> <br />
